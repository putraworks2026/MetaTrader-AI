//+------------------------------------------------------------------+
//| ExecConfig_v0.0.4.mqh — ExportTradeHistory Execution Configuration
//| Copyright 2026, PutraWorks
//| Action: Export to CSV
//+------------------------------------------------------------------+
#ifndef EXPORTTRADEHISTORY_EXEC_CONFIG_MQH
#define EXPORTTRADEHISTORY_EXEC_CONFIG_MQH
...
#endif // EXPORTTRADEHISTORY_EXEC_CONFIG_MQH
