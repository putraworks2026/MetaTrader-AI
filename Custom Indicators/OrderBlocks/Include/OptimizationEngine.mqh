...
//+------------------------------------------------------------------+
#ifndef ORDERBLOCKS_OPTIMIZATION_ENGINE_MQH
#define ORDERBLOCKS_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "OrderBlocks\\changes.csv";
...
#endif // ORDERBLOCKS_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
