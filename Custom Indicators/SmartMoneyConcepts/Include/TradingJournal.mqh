...
//+------------------------------------------------------------------+
#ifndef SMARTMONEYCONCEPTS_TRADING_JOURNAL_MQH
#define SMARTMONEYCONCEPTS_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "SmartMoneyConcepts");
...
CTradingJournal::CTradingJournal()
{
   ...
   m_folderName = "SmartMoneyConcepts";
   m_nextId = 1;
}
...
#endif // SMARTMONEYCONCEPTS_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
