...
//+------------------------------------------------------------------+
#ifndef LIQUIDITYZONES_STRATEGY_EVOLUTION_MQH
#define LIQUIDITYZONES_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "LiquidityZones\\profiles.csv";
...
#endif // LIQUIDITYZONES_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
