...
//+------------------------------------------------------------------+
#ifndef NEWSTRADINGEA_STRATEGY_EVOLUTION_MQH
#define NEWSTRADINGEA_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "NewsTradingEA\\profiles.csv";
...
#endif // NEWSTRADINGEA_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
