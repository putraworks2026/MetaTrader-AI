...
//+------------------------------------------------------------------+
#ifndef TRENDSTRENGTHMETER_REPORT_GENERATOR_MQH
#define TRENDSTRENGTHMETER_REPORT_GENERATOR_MQH
...
#endif // TRENDSTRENGTHMETER_REPORT_GENERATOR_MQH
//+------------------------------------------------------------------+
