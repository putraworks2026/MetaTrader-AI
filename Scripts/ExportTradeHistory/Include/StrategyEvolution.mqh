...
//+------------------------------------------------------------------+
#ifndef EXPORTTRADEHISTORY_STRATEGY_EVOLUTION_MQH
#define EXPORTTRADEHISTORY_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "ExportTradeHistory\\profiles.csv";
...
#endif // EXPORTTRADEHISTORY_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
