...
//+------------------------------------------------------------------+
#ifndef GRIDTRADINGEA_STRATEGY_EVOLUTION_MQH
#define GRIDTRADINGEA_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "GridTradingEA\\profiles.csv";
...
#endif // GRIDTRADINGEA_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
