//+------------------------------------------------------------------+
//| TrendStrengthMeter_TestSuite_v0.0.4.mq5 — Unit Tests
//| TrendStrengthMeter — Signal ML Test Suite (PutraWorks)
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for TrendStrengthMeter signal ML modules"
...
{
    Print("====================================");
    Print("  TrendStrengthMeter Signal ML Test Suite");
    Print("  Signal Type: ADX Trend Strength");
    Print("====================================");
