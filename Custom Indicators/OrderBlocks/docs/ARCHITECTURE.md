...
Identifies last opposite candle before impulse (ICT). Part of the PutraWorks MetaTrader-AI collection.
...
| SignalJournal | SignalJournal_v0.0.4.mqh | Tracks OB Mitigation signal accuracy (price after 1/5/10 bars) |
| SignalLearning | SignalLearning_v0.0.4.mqh | Learns which OB Mitigation conditions are reliable |
| SignalPatterns | SignalPatterns_v0.0.4.mqh | Scores OB Mitigation conditions by success rate |
...
```
OrderBlocks/
├── OrderBlocks_v0.0.4.mq5              # Main file — compile this
├── Include/
│   ├── OrderBlocks_v0.0.4.mqh           # Core indicator logic
...
├── Tests/OrderBlocks_TestSuite_v0.0.4.mq5
├── docs/
│   ├── ARCHITECTURE.md
│   ├── USER_GUIDE.md
│   └── CHANGELOG.md
...
└── Archive/                       # Previous versions (read-only)
    ├── OrderBlocks_v0.0.1.mq5
    ├── OrderBlocks_v0.0.2.mq5
    └── OrderBlocks_v0.0.3.mq5
```
