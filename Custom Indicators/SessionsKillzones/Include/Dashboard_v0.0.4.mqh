...
//| SessionsKillzones — Self-Improving MT5 AI Tool (PutraWorks)                    |
//+------------------------------------------------------------------+
#ifndef SESSIONSKILLZONES_DASHBOARD_MQH
#define SESSIONSKILLZONES_DASHBOARD_MQH
...
#endif // SESSIONSKILLZONES_DASHBOARD_MQH
//+------------------------------------------------------------------+
