...
//+------------------------------------------------------------------+
#ifndef AUTOSUPPORTRESISTANCE_PATTERN_RECOGNITION_MQH
#define AUTOSUPPORTRESISTANCE_PATTERN_RECOGNITION_MQH
...
#endif // AUTOSUPPORTRESISTANCE_PATTERN_RECOGNITION_MQH
//+------------------------------------------------------------------+
