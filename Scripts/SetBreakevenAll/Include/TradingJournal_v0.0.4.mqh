...
//+------------------------------------------------------------------+
#ifndef SETBREAKEVENALL_TRADING_JOURNAL_MQH
#define SETBREAKEVENALL_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "SetBreakevenAll");
...
#endif // SETBREAKEVENALL_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
