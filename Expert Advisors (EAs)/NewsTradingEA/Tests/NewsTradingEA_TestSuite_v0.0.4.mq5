//+------------------------------------------------------------------+
//| NewsTradingEA_TestSuite_v0.0.4.mq5 — Unit Tests (PutraWorks)
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for NewsTradingEA ML modules"
...
{
    Print("====================================");
    Print("  NewsTradingEA ML Test Suite");
    Print("====================================");
    TestConfig();
    TestRiskManager();
    TestTradingJournal();
