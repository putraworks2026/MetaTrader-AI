...
Push, email, and alert notification system. Part of the PutraWorks MetaTrader-AI collection.
...
Notifications/
├── Include/
│   └── Notifications.mqh          # Main library header
├── docs/
│   └── ARCHITECTURE.md    # This file
├── Publish/
│   └── README.md         # Market submission notes
└── Archive/
    └── Notifications_v0.0.1.mqh   # Previous version (read-only)
```
