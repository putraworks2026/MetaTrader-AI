//+------------------------------------------------------------------+
//| SignalDashboard_v0.0.4.mqh — FairValueGap Signal Accuracy Display
//| Copyright 2026, PutraWorks
//| Shows: FVG Fill/Bounce accuracy stats
//+------------------------------------------------------------------+
#ifndef FAIRVALUEGAP_SIGNAL_DASHBOARD_MQH
#define FAIRVALUEGAP_SIGNAL_DASHBOARD_MQH
...
public:
   ...
   void Update(string signalType, int totalSignals, int successes, int failures, double successRate, string topInsight, int patternCount)
   {
      ...
      Lbl(m_prefix+"title","FairValueGap Signal ML",m_x+10,m_y+5,clrGold,10);
      Lbl(m_prefix+"signal","Signal: FVG Fill/Bounce",m_x+10,m_y+22,clrSkyBlue,8);
...
#endif // FAIRVALUEGAP_SIGNAL_DASHBOARD_MQH
