//+------------------------------------------------------------------+
//| SignalConfig_v0.0.4.mqh — SmartMoneyConcepts Signal Configuration
//| Copyright 2026, PutraWorks
//| Signal Type: BOS/CHoCH
//+------------------------------------------------------------------+
#ifndef SMARTMONEYCONCEPTS_SIGNAL_CONFIG_MQH
#define SMARTMONEYCONCEPTS_SIGNAL_CONFIG_MQH
...
//--- SmartMoneyConcepts Signal Profile
...
#endif // SMARTMONEYCONCEPTS_SIGNAL_CONFIG_MQH
