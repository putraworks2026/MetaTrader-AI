//+------------------------------------------------------------------+
//| PatternRecognition_v0.0.4.mqh — BreakoutEA Pattern Detection
//| Copyright 2026, PutraWorks
//| Categories: RangeBreakout, VolumeBreakout, FalseBreakout, SessionBreakout
//+------------------------------------------------------------------+
#ifndef BREAKOUTEA_PATTERN_RECOGNITION_MQH
#define BREAKOUTEA_PATTERN_RECOGNITION_MQH
...
#endif // BREAKOUTEA_PATTERN_RECOGNITION_MQH
