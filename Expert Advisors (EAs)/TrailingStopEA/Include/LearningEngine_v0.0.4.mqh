//+------------------------------------------------------------------+
//| LearningEngine_v0.0.4.mqh — TrailingStopEA Post-Trade Learning
//| Copyright 2026, PutraWorks
//| Patterns: TrendContinuation, ReversalSignal, BreakevenHold, ProfitLock
//+------------------------------------------------------------------+
#ifndef TRAILINGSTOPEA_LEARNING_ENGINE_MQH
#define TRAILINGSTOPEA_LEARNING_ENGINE_MQH
...
public:
   ...
   {
      if(je.outcome==OUTCOME_WIN) { ML_Lesson l; l.category="TrendContinuation"; l.description="ATR trailing adapts better than fixed"; l.impact=1.0; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      else if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="TrendContinuation"; l.description="CONTRADICTS: ATR trailing adapts better than fixed"; l.impact=-0.5; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      if(je.outcome==OUTCOME_WIN) { ML_Lesson l; l.category="ReversalSignal"; l.description="Breakeven too early reduces PF"; l.impact=1.0; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      else if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="ReversalSignal"; l.description="CONTRADICTS: Breakeven too early reduces PF"; l.impact=-0.5; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="BreakevenHold"; l.description="Trailing best in ADX>25"; l.impact=-0.8; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="ProfitLock"; l.description="Step trailing captures more in strong trends"; l.impact=-0.8; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
...
#endif // TRAILINGSTOPEA_LEARNING_ENGINE_MQH
