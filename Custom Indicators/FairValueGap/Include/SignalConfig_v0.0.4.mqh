//+------------------------------------------------------------------+
//| SignalConfig_v0.0.4.mqh — FairValueGap Signal Configuration
//| Copyright 2026, PutraWorks
//| Signal Type: FVG Fill/Bounce
//+------------------------------------------------------------------+
#ifndef FAIRVALUEGAP_SIGNAL_CONFIG_MQH
#define FAIRVALUEGAP_SIGNAL_CONFIG_MQH
...
#endif // FAIRVALUEGAP_SIGNAL_CONFIG_MQH
