...
//+------------------------------------------------------------------+
#ifndef TRAILINGSTOPEA_STRATEGY_EVOLUTION_MQH
#define TRAILINGSTOPEA_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "TrailingStopEA\\profiles.csv";
...
#endif // TRAILINGSTOPEA_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
