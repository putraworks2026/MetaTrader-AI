...
//+------------------------------------------------------------------+
#ifndef RISKCALCULATOR_TRADING_JOURNAL_MQH
#define RISKCALCULATOR_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "RiskCalculator");
...
#endif // RISKCALCULATOR_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
