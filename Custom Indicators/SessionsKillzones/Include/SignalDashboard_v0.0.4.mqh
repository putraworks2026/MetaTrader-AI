//+------------------------------------------------------------------+
//| SignalDashboard_v0.0.4.mqh — SessionsKillzones Signal Accuracy Display
//| Copyright 2026, PutraWorks
//| Shows: Session Break accuracy stats
//+------------------------------------------------------------------+
#ifndef SESSIONSKILLZONES_SIGNAL_DASHBOARD_MQH
#define SESSIONSKILLZONES_SIGNAL_DASHBOARD_MQH
...
public:
   ...
   void Update(string signalType, int totalSignals, int successes, int failures, double successRate, string topInsight, int patternCount)
   {
      ...
      Lbl(m_prefix+"title","SessionsKillzones Signal ML",m_x+10,m_y+5,clrGold,10);
      Lbl(m_prefix+"signal","Signal: Session Break",m_x+10,m_y+22,clrSkyBlue,8);
...
#endif // SESSIONSKILLZONES_SIGNAL_DASHBOARD_MQH
