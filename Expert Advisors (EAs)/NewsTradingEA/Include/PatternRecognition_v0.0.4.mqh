//+------------------------------------------------------------------+
//| PatternRecognition_v0.0.4.mqh — NewsTradingEA Pattern Detection
//| Copyright 2026, PutraWorks
//| Categories: HighImpactSpike, MediumImpactSpike, PreNewsDrift, PostNewsReversal
//+------------------------------------------------------------------+
#ifndef NEWSTRADINGEA_PATTERN_RECOGNITION_MQH
#define NEWSTRADINGEA_PATTERN_RECOGNITION_MQH
...
#endif // NEWSTRADINGEA_PATTERN_RECOGNITION_MQH
