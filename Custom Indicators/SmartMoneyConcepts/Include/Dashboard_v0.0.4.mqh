...
//| SmartMoneyConcepts — Self-Improving MT5 AI Tool (PutraWorks)                    |
//+------------------------------------------------------------------+
#ifndef SMARTMONEYCONCEPTS_DASHBOARD_MQH
#define SMARTMONEYCONCEPTS_DASHBOARD_MQH
...
#endif // SMARTMONEYCONCEPTS_DASHBOARD_MQH
//+------------------------------------------------------------------+
