//+------------------------------------------------------------------+
//| ScalpingEA.mqh — Include file for ScalpingEA
//| MetaTrader AI — Function Library
//| Version: v0.0.2
//+------------------------------------------------------------------+
#ifndef __SCALPINGEA_MQH__
#define __SCALPINGEA_MQH__

//+------------------------------------------------------------------+
//|                                            ScalpingEA.mq5     |
//|                              MetaTrader AI - EAs                |
//|          #2 — Fast scalping on M1/M5 with spread filter         |
//+------------------------------------------------------------------+
