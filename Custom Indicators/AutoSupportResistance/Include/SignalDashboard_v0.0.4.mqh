//+------------------------------------------------------------------+
//| SignalDashboard_v0.0.4.mqh — AutoSupportResistance Signal Accuracy Display
//| Copyright 2026, PutraWorks
//| Shows: S/R Level Touch accuracy stats
//+------------------------------------------------------------------+
#ifndef AUTOSUPPORTRESISTANCE_SIGNAL_DASHBOARD_MQH
#define AUTOSUPPORTRESISTANCE_SIGNAL_DASHBOARD_MQH
...
public:
   ...
   void Update(string signalType, int totalSignals, int successes, int failures, double successRate, string topInsight, int patternCount)
   {
      ...
      Lbl(m_prefix+"title","AutoSupportResistance Signal ML",m_x+10,m_y+5,clrGold,10);
      Lbl(m_prefix+"signal","Signal: S/R Level Touch",m_x+10,m_y+22,clrSkyBlue,8);
...
#endif // AUTOSUPPORTRESISTANCE_SIGNAL_DASHBOARD_MQH
