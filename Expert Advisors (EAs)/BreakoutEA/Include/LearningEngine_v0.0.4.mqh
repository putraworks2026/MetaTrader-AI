//+------------------------------------------------------------------+
//| LearningEngine_v0.0.4.mqh — BreakoutEA Post-Trade Learning
//| Copyright 2026, PutraWorks
//| Patterns: RangeBreakout, VolumeBreakout, FalseBreakout, SessionBreakout
//+------------------------------------------------------------------+
#ifndef BREAKOUTEA_LEARNING_ENGINE_MQH
#define BREAKOUTEA_LEARNING_ENGINE_MQH
...
public:
   ...
   {
      if(je.outcome==OUTCOME_WIN) { ML_Lesson l; l.category="RangeBreakout"; l.description="Tight ranges produce stronger breakouts"; l.impact=1.0; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      else if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="RangeBreakout"; l.description="CONTRADICTS: Tight ranges produce stronger breakouts"; l.impact=-0.5; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      if(je.outcome==OUTCOME_WIN) { ML_Lesson l; l.category="VolumeBreakout"; l.description="Volume confirmation reduces false breakouts"; l.impact=1.0; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      else if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="VolumeBreakout"; l.description="CONTRADICTS: Volume confirmation reduces false breakouts"; l.impact=-0.5; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="FalseBreakout"; l.description="London session breakouts higher win rate"; l.impact=-0.8; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="SessionBreakout"; l.description="Low volatility breakouts fail more"; l.impact=-0.8; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
...
#endif // BREAKOUTEA_LEARNING_ENGINE_MQH
