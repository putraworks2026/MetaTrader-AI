//+------------------------------------------------------------------+
//| ReportGenerator_v0.0.4.mqh — BreakoutEA Performance Reports
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef BREAKOUTEA_REPORT_GENERATOR_MQH
#define BREAKOUTEA_REPORT_GENERATOR_MQH
...
public:
   ...
   { int h=FileOpen(m_fn,FILE_WRITE|FILE_TXT|FILE_ANSI); if(h==INVALID_HANDLE) return;
      FileWrite(h,"===== BreakoutEA Report ====="); FileWrite(h,TimeToString(TimeCurrent(),TIME_DATE|TIME_SECONDS));
...
#endif // BREAKOUTEA_REPORT_GENERATOR_MQH
