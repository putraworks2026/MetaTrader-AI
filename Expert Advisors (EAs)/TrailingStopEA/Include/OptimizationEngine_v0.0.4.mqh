//+------------------------------------------------------------------+
//| OptimizationEngine_v0.0.4.mqh — TrailingStopEA Adaptive Optimization
//| Copyright 2026, PutraWorks
//| Optimizable: trailMethod, trailPoints, breakevenTrigger, atrPeriod
//+------------------------------------------------------------------+
#ifndef TRAILINGSTOPEA_OPTIMIZATION_ENGINE_MQH
#define TRAILINGSTOPEA_OPTIMIZATION_ENGINE_MQH
...
#endif // TRAILINGSTOPEA_OPTIMIZATION_ENGINE_MQH
