...
//+------------------------------------------------------------------+
#ifndef TRENDSTRENGTHMETER_OPTIMIZATION_ENGINE_MQH
#define TRENDSTRENGTHMETER_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "TrendStrengthMeter\\changes.csv";
...
#endif // TRENDSTRENGTHMETER_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
