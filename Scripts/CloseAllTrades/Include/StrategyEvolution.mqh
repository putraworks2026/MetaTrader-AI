...
//+------------------------------------------------------------------+
#ifndef CLOSEALLTRADES_STRATEGY_EVOLUTION_MQH
#define CLOSEALLTRADES_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "CloseAllTrades\\profiles.csv";
...
#endif // CLOSEALLTRADES_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
