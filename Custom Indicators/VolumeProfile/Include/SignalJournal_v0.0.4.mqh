//+------------------------------------------------------------------+
//| SignalJournal_v0.0.4.mqh — VolumeProfile Signal Accuracy Journal
//| Copyright 2026, PutraWorks
//| Tracks: POC Touch
//+------------------------------------------------------------------+
#ifndef VOLUMEPROFILE_SIGNAL_JOURNAL_MQH
#define VOLUMEPROFILE_SIGNAL_JOURNAL_MQH

#include "SignalConfig_v0.0.4.mqh"

//--- VolumeProfile Signal Entry
struct SignalEntry
{
...
#endif // VOLUMEPROFILE_SIGNAL_JOURNAL_MQH
