//+------------------------------------------------------------------+
//| RiskManager_v0.0.4.mqh — GridTradingEA Risk Management
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef GRIDTRADINGEA_RISK_MANAGER_MQH
#define GRIDTRADINGEA_RISK_MANAGER_MQH
...
#endif // GRIDTRADINGEA_RISK_MANAGER_MQH
