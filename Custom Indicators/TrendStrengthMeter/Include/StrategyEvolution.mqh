...
//+------------------------------------------------------------------+
#ifndef TRENDSTRENGTHMETER_STRATEGY_EVOLUTION_MQH
#define TRENDSTRENGTHMETER_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "TrendStrengthMeter\\profiles.csv";
...
#endif // TRENDSTRENGTHMETER_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
