//+------------------------------------------------------------------+
//| GridTradingEA_TestSuite_v0.0.4.mq5 — Unit Tests (PutraWorks)
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for GridTradingEA ML modules"
...
{
    Print("====================================");
    Print("  GridTradingEA ML Test Suite");
    Print("====================================");
    TestConfig();
    TestRiskManager();
    TestTradingJournal();
