# SessionsKillzones — User Guide

## Description

London/NY/Asia session boxes with killzone highlights.

## Installation

1. Copy the entire `SessionsKillzones/` folder to your MT5 `MQL5/Indicators/` directory
2. Open MetaEditor (F4 in MT5 terminal)
3. Navigate to the `SessionsKillzones/` folder
4. Compile `SessionsKillzones_v0.0.4.mq5` (F7)
...
- Which market regimes favor Session Break signals
...
ML data is stored in `MQL5/Files/SessionsKillzones/`:
...
Run the test suite:
1. Compile `Tests/SessionsKillzones_TestSuite_v0.0.4.mq5` in MetaEditor
