//+------------------------------------------------------------------+
//| OptimizationEngine_v0.0.4.mqh — BreakoutEA Adaptive Optimization
//| Copyright 2026, PutraWorks
//| Optimizable: rangePeriod, volumePeriod, volumeMultiplier, breakoutThreshold
//+------------------------------------------------------------------+
#ifndef BREAKOUTEA_OPTIMIZATION_ENGINE_MQH
#define BREAKOUTEA_OPTIMIZATION_ENGINE_MQH
...
#endif // BREAKOUTEA_OPTIMIZATION_ENGINE_MQH
