...
//+------------------------------------------------------------------+
#ifndef SESSIONSKILLZONES_OPTIMIZATION_ENGINE_MQH
#define SESSIONSKILLZONES_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "SessionsKillzones\\changes.csv";
...
#endif // SESSIONSKILLZONES_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
