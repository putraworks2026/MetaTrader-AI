...
//+------------------------------------------------------------------+
#ifndef EXPORTTRADEHISTORY_OPTIMIZATION_ENGINE_MQH
#define EXPORTTRADEHISTORY_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "ExportTradeHistory\\changes.csv";
...
#endif // EXPORTTRADEHISTORY_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
