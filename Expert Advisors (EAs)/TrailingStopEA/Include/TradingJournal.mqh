...
//+------------------------------------------------------------------+
#ifndef TRAILINGSTOPEA_TRADING_JOURNAL_MQH
#define TRAILINGSTOPEA_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "TrailingStopEA");
...
#endif // TRAILINGSTOPEA_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
