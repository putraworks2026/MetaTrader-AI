...
//+------------------------------------------------------------------+
#ifndef FIBONACCIAUTODRAW_STRATEGY_EVOLUTION_MQH
#define FIBONACCIAUTODRAW_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "FibonacciAutoDraw\\profiles.csv";
...
#endif // FIBONACCIAUTODRAW_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
