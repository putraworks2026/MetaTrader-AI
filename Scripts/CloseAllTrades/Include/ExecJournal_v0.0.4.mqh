//+------------------------------------------------------------------+
//| ExecJournal_v0.0.4.mqh — CloseAllTrades Execution Journal
//| Copyright 2026, PutraWorks
//| Logs each: Close Positions
//+------------------------------------------------------------------+
#ifndef CLOSEALLTRADES_EXEC_JOURNAL_MQH
#define CLOSEALLTRADES_EXEC_JOURNAL_MQH
...
#endif // CLOSEALLTRADES_EXEC_JOURNAL_MQH
