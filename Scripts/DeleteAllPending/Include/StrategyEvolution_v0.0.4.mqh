...
//+------------------------------------------------------------------+
#ifndef DELETEALLPENDING_STRATEGY_EVOLUTION_MQH
#define DELETEALLPENDING_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "DeleteAllPending\\profiles.csv";
...
#endif // DELETEALLPENDING_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
