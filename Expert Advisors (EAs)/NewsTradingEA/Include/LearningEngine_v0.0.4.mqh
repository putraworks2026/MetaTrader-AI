//+------------------------------------------------------------------+
//| LearningEngine_v0.0.4.mqh — NewsTradingEA Post-Trade Learning
//| Copyright 2026, PutraWorks
//| Patterns: HighImpactSpike, MediumImpactSpike, PreNewsDrift, PostNewsReversal
//+------------------------------------------------------------------+
#ifndef NEWSTRADINGEA_LEARNING_ENGINE_MQH
#define NEWSTRADINGEA_LEARNING_ENGINE_MQH
...
public:
   ...
   {
      if(je.outcome==OUTCOME_WIN) { ML_Lesson l; l.category="HighImpactSpike"; l.description="High impact = bigger spikes more reversals"; l.impact=1.0; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      else if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="HighImpactSpike"; l.description="CONTRADICTS: High impact = bigger spikes more reversals"; l.impact=-0.5; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      if(je.outcome==OUTCOME_WIN) { ML_Lesson l; l.category="MediumImpactSpike"; l.description="Straddle fails when spread 2x normal"; l.impact=1.0; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      else if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="MediumImpactSpike"; l.description="CONTRADICTS: Straddle fails when spread 2x normal"; l.impact=-0.5; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="PreNewsDrift"; l.description="Pre-news drift indicates direction"; l.impact=-0.8; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="PostNewsReversal"; l.description="Post-news reversals 60% within 5 min"; l.impact=-0.8; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
...
#endif // NEWSTRADINGEA_LEARNING_ENGINE_MQH
