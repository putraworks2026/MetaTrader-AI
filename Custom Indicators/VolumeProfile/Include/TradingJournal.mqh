...
//+------------------------------------------------------------------+
#ifndef VOLUMEPROFILE_TRADING_JOURNAL_MQH
#define VOLUMEPROFILE_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "VolumeProfile");
...
#endif // VOLUMEPROFILE_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
