...
//| ExportTradeHistory — Self-Improving MT5 AI Tool (PutraWorks)                    |
//+------------------------------------------------------------------+
#ifndef EXPORTTRADEHISTORY_DASHBOARD_MQH
#define EXPORTTRADEHISTORY_DASHBOARD_MQH
...
#endif // EXPORTTRADEHISTORY_DASHBOARD_MQH
//+------------------------------------------------------------------+
