# BreakoutEA — Changelog

## v0.0.4 — 2026-08-09

### Changed
- Replaced generic AIEA copies with tool-specific ML modules
- Config now has BreakoutEA-specific parameters: rangePeriod, volumePeriod, volumeMultiplier, breakoutThreshold
- LearningEngine now has BreakoutEA-specific lessons for RangeBreakout, VolumeBreakout, FalseBreakout, SessionBreakout
- PatternRecognition now tracks BreakoutEA-specific patterns: RangeBreakout, VolumeBreakout, FalseBreakout, SessionBreakout
