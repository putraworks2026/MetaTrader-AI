//+------------------------------------------------------------------+
//| DeleteAllPending_TestSuite_v0.0.4.mq5 — Unit Tests
//| DeleteAllPending — Execution ML Test Suite (PutraWorks)
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for DeleteAllPending execution ML modules"
...
{
    Print("====================================");
    Print("  DeleteAllPending Execution ML Test Suite");
    Print("  Action: Delete Pending Orders");
    Print("====================================");
