...
//+------------------------------------------------------------------+
#ifndef GRIDTRADINGEA_TRADING_JOURNAL_MQH
#define GRIDTRADINGEA_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "GridTradingEA");
...
#endif // GRIDTRADINGEA_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
