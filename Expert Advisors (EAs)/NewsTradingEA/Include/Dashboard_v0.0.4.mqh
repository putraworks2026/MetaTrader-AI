...
//| NewsTradingEA — Self-Improving MT5 AI Tool (PutraWorks)                    |
//+------------------------------------------------------------------+
#ifndef NEWSTRADINGEA_DASHBOARD_MQH
#define NEWSTRADINGEA_DASHBOARD_MQH
...
#endif // NEWSTRADINGEA_DASHBOARD_MQH
//+------------------------------------------------------------------+
