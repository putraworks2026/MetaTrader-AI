...
//+------------------------------------------------------------------+
#ifndef SUPPLYDEMANDZONES_OPTIMIZATION_ENGINE_MQH
#define SUPPLYDEMANDZONES_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "SupplyDemandZones\\changes.csv";
...
#endif // SUPPLYDEMANDZONES_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
