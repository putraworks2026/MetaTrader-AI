...
//+------------------------------------------------------------------+
#ifndef VOLUMEPROFILE_OPTIMIZATION_ENGINE_MQH
#define VOLUMEPROFILE_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "VolumeProfile\\changes.csv";
...
#endif // VOLUMEPROFILE_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
