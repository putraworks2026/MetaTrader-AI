...
//+------------------------------------------------------------------+
#ifndef TRENDSTRENGTHMETER_TRADING_JOURNAL_MQH
#define TRENDSTRENGTHMETER_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "TrendStrengthMeter");
...
CTradingJournal::CTradingJournal()
{
   ...
   m_folderName = "TrendStrengthMeter";
   m_nextId = 1;
}
...
#endif // TRENDSTRENGTHMETER_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
