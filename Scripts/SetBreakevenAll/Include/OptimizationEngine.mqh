...
//+------------------------------------------------------------------+
#ifndef SETBREAKEVENALL_OPTIMIZATION_ENGINE_MQH
#define SETBREAKEVENALL_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "SetBreakevenAll\\changes.csv";
...
#endif // SETBREAKEVENALL_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
