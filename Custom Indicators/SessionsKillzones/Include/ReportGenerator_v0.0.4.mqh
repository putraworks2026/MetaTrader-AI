...
//+------------------------------------------------------------------+
#ifndef SESSIONSKILLZONES_REPORT_GENERATOR_MQH
#define SESSIONSKILLZONES_REPORT_GENERATOR_MQH
...
#endif // SESSIONSKILLZONES_REPORT_GENERATOR_MQH
//+------------------------------------------------------------------+
