...
//| RiskCalculator — Self-Improving MT5 AI Tool (PutraWorks)                    |
//+------------------------------------------------------------------+
#ifndef RISKCALCULATOR_DASHBOARD_MQH
#define RISKCALCULATOR_DASHBOARD_MQH
...
#endif // RISKCALCULATOR_DASHBOARD_MQH
//+------------------------------------------------------------------+
