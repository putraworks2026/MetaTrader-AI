...
//+------------------------------------------------------------------+
#ifndef VOLUMEPROFILE_STRATEGY_EVOLUTION_MQH
#define VOLUMEPROFILE_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "VolumeProfile\\profiles.csv";
...
#endif // VOLUMEPROFILE_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
