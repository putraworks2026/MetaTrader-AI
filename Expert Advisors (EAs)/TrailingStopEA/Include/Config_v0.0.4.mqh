//+------------------------------------------------------------------+
//| Config_v0.0.4.mqh — TrailingStopEA Configuration
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef TRAILINGSTOPEA_CONFIG_MQH
#define TRAILINGSTOPEA_CONFIG_MQH
...
{
   ps.id=id; ps.name="Default"; ps.trailMethod = 0;
   ps.trailPoints = 50;
   ps.breakevenTrigger = 30;
   ps.atrPeriod = 14;
...
#endif // TRAILINGSTOPEA_CONFIG_MQH
