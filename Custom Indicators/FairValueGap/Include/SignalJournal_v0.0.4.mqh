//+------------------------------------------------------------------+
//| SignalJournal_v0.0.4.mqh — FairValueGap Signal Accuracy Journal
//| Copyright 2026, PutraWorks
//| Tracks: FVG Fill/Bounce
//+------------------------------------------------------------------+
#ifndef FAIRVALUEGAP_SIGNAL_JOURNAL_MQH
#define FAIRVALUEGAP_SIGNAL_JOURNAL_MQH

#include "SignalConfig_v0.0.4.mqh"

//--- FairValueGap Signal Entry
struct SignalEntry
{
...
#endif // FAIRVALUEGAP_SIGNAL_JOURNAL_MQH
