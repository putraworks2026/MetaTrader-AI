//+------------------------------------------------------------------+
//| RiskManager_v0.0.4.mqh — NewsTradingEA Risk Management
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef NEWSTRADINGEA_RISK_MANAGER_MQH
#define NEWSTRADINGEA_RISK_MANAGER_MQH
...
#endif // NEWSTRADINGEA_RISK_MANAGER_MQH
