...
//+------------------------------------------------------------------+
#ifndef FIBONACCIAUTODRAW_TRADING_JOURNAL_MQH
#define FIBONACCIAUTODRAW_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "FibonacciAutoDraw");
...
CTradingJournal::CTradingJournal()
{
   ...
   m_folderName = "FibonacciAutoDraw";
   m_nextId = 1;
}
...
#endif // FIBONACCIAUTODRAW_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
