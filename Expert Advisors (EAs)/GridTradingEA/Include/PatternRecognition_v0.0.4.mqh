//+------------------------------------------------------------------+
//| PatternRecognition_v0.0.4.mqh — GridTradingEA Pattern Detection
//| Copyright 2026, PutraWorks
//| Categories: RangeBound, TrendingUp, TrendingDown, GridRecovery
//+------------------------------------------------------------------+
#ifndef GRIDTRADINGEA_PATTERN_RECOGNITION_MQH
#define GRIDTRADINGEA_PATTERN_RECOGNITION_MQH
...
#endif // GRIDTRADINGEA_PATTERN_RECOGNITION_MQH
