...
//+------------------------------------------------------------------+
#ifndef FAIRVALUEGAP_TRADING_JOURNAL_MQH
#define FAIRVALUEGAP_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "FairValueGap");
...
#endif // FAIRVALUEGAP_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
