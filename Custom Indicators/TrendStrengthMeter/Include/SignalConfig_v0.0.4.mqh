//+------------------------------------------------------------------+
//| SignalConfig_v0.0.4.mqh — TrendStrengthMeter Signal Configuration
//| Copyright 2026, PutraWorks
//| Signal Type: ADX Trend Strength
//+------------------------------------------------------------------+
#ifndef TRENDSTRENGTHMETER_SIGNAL_CONFIG_MQH
#define TRENDSTRENGTHMETER_SIGNAL_CONFIG_MQH
...
//--- TrendStrengthMeter Signal Profile
...
#endif // TRENDSTRENGTHMETER_SIGNAL_CONFIG_MQH
