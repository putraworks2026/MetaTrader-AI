...
//+------------------------------------------------------------------+
#ifndef DELETEALLPENDING_OPTIMIZATION_ENGINE_MQH
#define DELETEALLPENDING_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "DeleteAllPending\\changes.csv";
...
#endif // DELETEALLPENDING_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
