...
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for SessionsKillzones modules"
...
void TestTradingJournal()
{
   ...
   journal.Init("SessionsKillzones");
...
{
   Print("====================================");
   Print("  SessionsKillzones Test Suite");
   Print("====================================");
