...
//+------------------------------------------------------------------+
#ifndef SUPPLYDEMANDZONES_REPORT_GENERATOR_MQH
#define SUPPLYDEMANDZONES_REPORT_GENERATOR_MQH
...
#endif // SUPPLYDEMANDZONES_REPORT_GENERATOR_MQH
//+------------------------------------------------------------------+
