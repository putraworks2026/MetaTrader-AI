//+------------------------------------------------------------------+
//| Config_v0.0.4.mqh — NewsTradingEA Configuration
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef NEWSTRADINGEA_CONFIG_MQH
#define NEWSTRADINGEA_CONFIG_MQH
...
{
   int id; string name;
   double   newsWindowMin;
   double   straddleDistance;
   double   minImpact;
   double   volatilityTP;
...
{
   ps.id=id; ps.name="Default"; ps.newsWindowMin = 5;
   ps.straddleDistance = 30;
   ps.minImpact = 2;
   ps.volatilityTP = 100;
...
#endif // NEWSTRADINGEA_CONFIG_MQH
