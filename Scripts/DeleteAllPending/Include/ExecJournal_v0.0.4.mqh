//+------------------------------------------------------------------+
//| ExecJournal_v0.0.4.mqh — DeleteAllPending Execution Journal
//| Copyright 2026, PutraWorks
//| Logs each: Delete Pending Orders
//+------------------------------------------------------------------+
#ifndef DELETEALLPENDING_EXEC_JOURNAL_MQH
#define DELETEALLPENDING_EXEC_JOURNAL_MQH
...
#endif // DELETEALLPENDING_EXEC_JOURNAL_MQH
