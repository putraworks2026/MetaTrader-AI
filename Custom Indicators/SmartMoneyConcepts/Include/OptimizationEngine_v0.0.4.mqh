...
//+------------------------------------------------------------------+
#ifndef SMARTMONEYCONCEPTS_OPTIMIZATION_ENGINE_MQH
#define SMARTMONEYCONCEPTS_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "SmartMoneyConcepts\\changes.csv";
...
#endif // SMARTMONEYCONCEPTS_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
