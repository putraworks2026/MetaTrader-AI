//+------------------------------------------------------------------+
//| SessionsKillzones_TestSuite_v0.0.4.mq5 — Unit Tests
//| SessionsKillzones — Signal ML Test Suite (PutraWorks)
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for SessionsKillzones signal ML modules"
...
{
    Print("====================================");
    Print("  SessionsKillzones Signal ML Test Suite");
    Print("  Signal Type: Session Break");
    Print("====================================");
