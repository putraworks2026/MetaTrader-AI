...
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for SupplyDemandZones modules"
...
void TestTradingJournal()
{
   ...
   journal.Init("SupplyDemandZones");
...
{
   Print("====================================");
   Print("  SupplyDemandZones Test Suite");
   Print("====================================");
