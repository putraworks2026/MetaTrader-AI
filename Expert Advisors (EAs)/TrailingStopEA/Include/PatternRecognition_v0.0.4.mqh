//+------------------------------------------------------------------+
//| PatternRecognition_v0.0.4.mqh — TrailingStopEA Pattern Detection
//| Copyright 2026, PutraWorks
//| Categories: TrendContinuation, ReversalSignal, BreakevenHold, ProfitLock
//+------------------------------------------------------------------+
#ifndef TRAILINGSTOPEA_PATTERN_RECOGNITION_MQH
#define TRAILINGSTOPEA_PATTERN_RECOGNITION_MQH
...
#endif // TRAILINGSTOPEA_PATTERN_RECOGNITION_MQH
