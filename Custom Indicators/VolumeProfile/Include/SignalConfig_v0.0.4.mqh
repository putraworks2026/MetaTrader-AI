//+------------------------------------------------------------------+
//| SignalConfig_v0.0.4.mqh — VolumeProfile Signal Configuration
//| Copyright 2026, PutraWorks
//| Signal Type: POC Touch
//+------------------------------------------------------------------+
#ifndef VOLUMEPROFILE_SIGNAL_CONFIG_MQH
#define VOLUMEPROFILE_SIGNAL_CONFIG_MQH
...
#endif // VOLUMEPROFILE_SIGNAL_CONFIG_MQH
