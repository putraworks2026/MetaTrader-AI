...
//| VolumeProfile — Self-Improving MT5 AI Tool (PutraWorks)                    |
//+------------------------------------------------------------------+
#ifndef VOLUMEPROFILE_DASHBOARD_MQH
#define VOLUMEPROFILE_DASHBOARD_MQH
...
#endif // VOLUMEPROFILE_DASHBOARD_MQH
//+------------------------------------------------------------------+
