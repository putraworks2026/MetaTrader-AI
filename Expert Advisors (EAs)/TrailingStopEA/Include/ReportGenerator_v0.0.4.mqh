//+------------------------------------------------------------------+
//| ReportGenerator_v0.0.4.mqh — TrailingStopEA Performance Reports
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef TRAILINGSTOPEA_REPORT_GENERATOR_MQH
#define TRAILINGSTOPEA_REPORT_GENERATOR_MQH
...
public:
   ...
   { int h=FileOpen(m_fn,FILE_WRITE|FILE_TXT|FILE_ANSI); if(h==INVALID_HANDLE) return;
      FileWrite(h,"===== TrailingStopEA Report ====="); FileWrite(h,TimeToString(TimeCurrent(),TIME_DATE|TIME_SECONDS));
...
#endif // TRAILINGSTOPEA_REPORT_GENERATOR_MQH
