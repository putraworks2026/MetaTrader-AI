...
//+------------------------------------------------------------------+
#ifndef FIBONACCIAUTODRAW_OPTIMIZATION_ENGINE_MQH
#define FIBONACCIAUTODRAW_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "FibonacciAutoDraw\\changes.csv";
...
#endif // FIBONACCIAUTODRAW_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
