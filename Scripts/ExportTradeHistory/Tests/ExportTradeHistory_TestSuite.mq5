...
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for ExportTradeHistory modules"
...
void TestTradingJournal()
{
   ...
   journal.Init("ExportTradeHistory");
...
{
   Print("====================================");
   Print("  ExportTradeHistory Test Suite");
   Print("====================================");
