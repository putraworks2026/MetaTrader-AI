...
//+------------------------------------------------------------------+
#ifndef EXPORTTRADEHISTORY_TRADING_JOURNAL_MQH
#define EXPORTTRADEHISTORY_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "ExportTradeHistory");
...
CTradingJournal::CTradingJournal()
{
   ...
   m_folderName = "ExportTradeHistory";
   m_nextId = 1;
}
...
#endif // EXPORTTRADEHISTORY_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
