...
Position sizing, drawdown limits, daily loss caps. Part of the PutraWorks MetaTrader-AI collection.
...
RiskManager/
├── Include/
│   └── RiskManager.mqh          # Main library header
├── docs/
│   └── ARCHITECTURE.md    # This file
├── Publish/
│   └── README.md         # Market submission notes
└── Archive/
    └── RiskManager_v0.0.1.mqh   # Previous version (read-only)
```
