# TimeSession — Architecture

## Overview

Trading session detection and time management. Part of the PutraWorks MetaTrader-AI collection.
...
TimeSession/
├── Include/
│   └── TimeSession.mqh          # Main library header
├── docs/
│   └── ARCHITECTURE.md    # This file
├── Publish/
│   └── README.md         # Market submission notes
└── Archive/
    └── TimeSession_v0.0.1.mqh   # Previous version (read-only)
```
