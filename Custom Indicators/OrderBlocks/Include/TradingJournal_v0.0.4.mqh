...
//+------------------------------------------------------------------+
#ifndef ORDERBLOCKS_TRADING_JOURNAL_MQH
#define ORDERBLOCKS_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "OrderBlocks");
...
#endif // ORDERBLOCKS_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
