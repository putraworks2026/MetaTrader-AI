//+------------------------------------------------------------------+
//| AutoSupportResistance_TestSuite_v0.0.4.mq5 — Unit Tests
//| AutoSupportResistance — Signal ML Test Suite (PutraWorks)
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for AutoSupportResistance signal ML modules"
...
{
    Print("====================================");
    Print("  AutoSupportResistance Signal ML Test Suite");
    Print("  Signal Type: S/R Level Touch");
    Print("====================================");
