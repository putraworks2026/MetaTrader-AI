//+------------------------------------------------------------------+
//| IndicatorEngine_v0.0.4.mqh — ScalpingEA Indicator Management
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef SCALPINGEA_INDICATOR_ENGINE_MQH
#define SCALPINGEA_INDICATOR_ENGINE_MQH
...
#endif // SCALPINGEA_INDICATOR_ENGINE_MQH
