...
//| Part of: DeleteAllPending v0.0.3
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef __ML_JOURNAL_DELETEALLPENDING_MQH__
#define __ML_JOURNAL_DELETEALLPENDING_MQH__
...
#endif // __ML_JOURNAL_DELETEALLPENDING_MQH__
