//+------------------------------------------------------------------+
//| Config_v0.0.4.mqh — BreakoutEA Configuration
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef BREAKOUTEA_CONFIG_MQH
#define BREAKOUTEA_CONFIG_MQH
...
{
   ps.id=id; ps.name="Default"; ps.rangePeriod = 20;
   ps.volumePeriod = 10;
   ps.volumeMultiplier = 1.5;
   ps.breakoutThreshold = 0.0;
