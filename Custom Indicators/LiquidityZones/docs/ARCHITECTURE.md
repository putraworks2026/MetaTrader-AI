...
Detects equal highs/lows as liquidity pools. Part of the PutraWorks MetaTrader-AI collection.

## Signal Type

This indicator generates **Liquidity Sweep** signals.

## ML Module Architecture

```
┌─────────────────────────────────────────────────────────┐
│                  LiquidityZones_v0.0.4.mq5                       │
...
| SignalJournal | SignalJournal_v0.0.4.mqh | Tracks Liquidity Sweep signal accuracy (price after 1/5/10 bars) |
| SignalLearning | SignalLearning_v0.0.4.mqh | Learns which Liquidity Sweep conditions are reliable |
| SignalPatterns | SignalPatterns_v0.0.4.mqh | Scores Liquidity Sweep conditions by success rate |
...
```
LiquidityZones/
├── LiquidityZones_v0.0.4.mq5              # Main file — compile this
├── Include/
│   ├── LiquidityZones_v0.0.4.mqh           # Core indicator logic
...
├── Tests/LiquidityZones_TestSuite_v0.0.4.mq5
├── docs/
│   ├── ARCHITECTURE.md
│   ├── USER_GUIDE.md
│   └── CHANGELOG.md
...
└── Archive/                       # Previous versions (read-only)
    ├── LiquidityZones_v0.0.1.mq5
    ├── LiquidityZones_v0.0.2.mq5
    └── LiquidityZones_v0.0.3.mq5
```
