//+------------------------------------------------------------------+
//| ReportGenerator_v0.0.4.mqh — NewsTradingEA Performance Reports
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef NEWSTRADINGEA_REPORT_GENERATOR_MQH
#define NEWSTRADINGEA_REPORT_GENERATOR_MQH
...
public:
   ...
   { int h=FileOpen(m_fn,FILE_WRITE|FILE_TXT|FILE_ANSI); if(h==INVALID_HANDLE) return;
      FileWrite(h,"===== NewsTradingEA Report ====="); FileWrite(h,TimeToString(TimeCurrent(),TIME_DATE|TIME_SECONDS));
...
#endif // NEWSTRADINGEA_REPORT_GENERATOR_MQH
