...
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for TrendStrengthMeter modules"
...
void TestTradingJournal()
{
   ...
   journal.Init("TrendStrengthMeter");
...
{
   Print("====================================");
   Print("  TrendStrengthMeter Test Suite");
   Print("====================================");
