...
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for AutoSupportResistance modules"
...
void TestTradingJournal()
{
   ...
   journal.Init("AutoSupportResistance");
...
{
   Print("====================================");
   Print("  AutoSupportResistance Test Suite");
   Print("====================================");
