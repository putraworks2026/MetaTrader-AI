...
//+------------------------------------------------------------------+
#ifndef RISKCALCULATOR_STRATEGY_EVOLUTION_MQH
#define RISKCALCULATOR_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "RiskCalculator\\profiles.csv";
...
#endif // RISKCALCULATOR_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
