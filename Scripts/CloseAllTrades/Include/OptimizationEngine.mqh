...
//+------------------------------------------------------------------+
#ifndef CLOSEALLTRADES_OPTIMIZATION_ENGINE_MQH
#define CLOSEALLTRADES_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "CloseAllTrades\\changes.csv";
...
#endif // CLOSEALLTRADES_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
