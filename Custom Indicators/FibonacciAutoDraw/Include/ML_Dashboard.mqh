...
//| Part of: FibonacciAutoDraw v0.0.3
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef __ML_DASHBOARD_FIBONACCIAUTODRAW_MQH__
#define __ML_DASHBOARD_FIBONACCIAUTODRAW_MQH__
...
#endif // __ML_DASHBOARD_FIBONACCIAUTODRAW_MQH__
