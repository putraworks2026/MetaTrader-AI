...
//+------------------------------------------------------------------+
#ifndef ORDERBLOCKS_STRATEGY_EVOLUTION_MQH
#define ORDERBLOCKS_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "OrderBlocks\\profiles.csv";
...
#endif // ORDERBLOCKS_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
