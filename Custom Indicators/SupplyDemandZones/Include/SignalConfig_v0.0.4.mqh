//+------------------------------------------------------------------+
//| SignalConfig_v0.0.4.mqh — SupplyDemandZones Signal Configuration
//| Copyright 2026, PutraWorks
//| Signal Type: Zone Touch
//+------------------------------------------------------------------+
#ifndef SUPPLYDEMANDZONES_SIGNAL_CONFIG_MQH
#define SUPPLYDEMANDZONES_SIGNAL_CONFIG_MQH
...
//--- SupplyDemandZones Signal Profile
...
#endif // SUPPLYDEMANDZONES_SIGNAL_CONFIG_MQH
