//+------------------------------------------------------------------+
//| SignalDashboard_v0.0.4.mqh — TrendStrengthMeter Signal Accuracy Display
//| Copyright 2026, PutraWorks
//| Shows: ADX Trend Strength accuracy stats
//+------------------------------------------------------------------+
#ifndef TRENDSTRENGTHMETER_SIGNAL_DASHBOARD_MQH
#define TRENDSTRENGTHMETER_SIGNAL_DASHBOARD_MQH
...
public:
   ...
   void Update(string signalType, int totalSignals, int successes, int failures, double successRate, string topInsight, int patternCount)
   {
      ...
      Lbl(m_prefix+"title","TrendStrengthMeter Signal ML",m_x+10,m_y+5,clrGold,10);
      Lbl(m_prefix+"signal","Signal: ADX Trend Strength",m_x+10,m_y+22,clrSkyBlue,8);
...
#endif // TRENDSTRENGTHMETER_SIGNAL_DASHBOARD_MQH
