...
//+------------------------------------------------------------------+
#ifndef SMARTMONEYCONCEPTS_STRATEGY_EVOLUTION_MQH
#define SMARTMONEYCONCEPTS_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "SmartMoneyConcepts\\profiles.csv";
...
#endif // SMARTMONEYCONCEPTS_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
