//+------------------------------------------------------------------+
//| ExecConfig_v0.0.4.mqh — RiskCalculator Execution Configuration
//| Copyright 2026, PutraWorks
//| Action: Calculate Lot Size
//+------------------------------------------------------------------+
#ifndef RISKCALCULATOR_EXEC_CONFIG_MQH
#define RISKCALCULATOR_EXEC_CONFIG_MQH
...
#endif // RISKCALCULATOR_EXEC_CONFIG_MQH
