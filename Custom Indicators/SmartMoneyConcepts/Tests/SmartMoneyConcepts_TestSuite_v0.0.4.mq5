...
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for SmartMoneyConcepts modules"
...
void TestTradingJournal()
{
   ...
   journal.Init("SmartMoneyConcepts");
...
{
   Print("====================================");
   Print("  SmartMoneyConcepts Test Suite");
   Print("====================================");
