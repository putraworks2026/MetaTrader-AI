//+------------------------------------------------------------------+
//| NewsManager_v0.0.4.mqh — TrailingStopEA Economic News Filter
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef TRAILINGSTOPEA_NEWS_MANAGER_MQH
#define TRAILINGSTOPEA_NEWS_MANAGER_MQH
...
#endif // TRAILINGSTOPEA_NEWS_MANAGER_MQH
