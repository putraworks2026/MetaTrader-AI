...
//+------------------------------------------------------------------+
#ifndef RISKCALCULATOR_OPTIMIZATION_ENGINE_MQH
#define RISKCALCULATOR_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "RiskCalculator\\changes.csv";
...
#endif // RISKCALCULATOR_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
