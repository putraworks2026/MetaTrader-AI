...
//| DeleteAllPending — Self-Improving MT5 AI Tool (PutraWorks)                    |
//+------------------------------------------------------------------+
#ifndef DELETEALLPENDING_DASHBOARD_MQH
#define DELETEALLPENDING_DASHBOARD_MQH
...
#endif // DELETEALLPENDING_DASHBOARD_MQH
//+------------------------------------------------------------------+
