//+------------------------------------------------------------------+
//| IndicatorEngine_v0.0.4.mqh — BreakoutEA Indicator Management
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef BREAKOUTEA_INDICATOR_ENGINE_MQH
#define BREAKOUTEA_INDICATOR_ENGINE_MQH
...
#endif // BREAKOUTEA_INDICATOR_ENGINE_MQH
