//+------------------------------------------------------------------+
//| SignalJournal_v0.0.4.mqh — LiquidityZones Signal Accuracy Journal
//| Copyright 2026, PutraWorks
//| Tracks: Liquidity Sweep
//+------------------------------------------------------------------+
#ifndef LIQUIDITYZONES_SIGNAL_JOURNAL_MQH
#define LIQUIDITYZONES_SIGNAL_JOURNAL_MQH

#include "SignalConfig_v0.0.4.mqh"

//--- LiquidityZones Signal Entry
struct SignalEntry
{
...
#endif // LIQUIDITYZONES_SIGNAL_JOURNAL_MQH
