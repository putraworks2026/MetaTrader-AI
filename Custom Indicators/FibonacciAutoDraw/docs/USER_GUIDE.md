# FibonacciAutoDraw — User Guide

## Description

Auto-identifies swings and draws fib levels.

## Installation

1. Copy the entire `FibonacciAutoDraw/` folder to your MT5 `MQL5/Indicators/` directory
2. Open MetaEditor (F4 in MT5 terminal)
3. Navigate to the `FibonacciAutoDraw/` folder
4. Compile `FibonacciAutoDraw_v0.0.4.mq5` (F7)
...
- Which market regimes favor Fib Retracement Touch signals
...
- Signal type: Fib Retracement Touch
...
ML data is stored in `MQL5/Files/FibonacciAutoDraw/`:
...
Run the test suite:
1. Compile `Tests/FibonacciAutoDraw_TestSuite_v0.0.4.mq5` in MetaEditor
