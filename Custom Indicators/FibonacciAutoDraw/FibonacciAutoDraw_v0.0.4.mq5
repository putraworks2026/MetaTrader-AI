//+------------------------------------------------------------------+
//| FibonacciAutoDraw_v0.0.4.mq5 — Publish Entry Point
...
#include "Include\\FibonacciAutoDraw_v0.0.4.mqh"
...
void ML_Init()
{
    g_signalJournal.Init("FibonacciAutoDraw");
    g_signalLearning.Init("FibonacciAutoDraw");
    g_signalDashboard.Init("FibonacciAutoDraw");
    Print("[ML] FibonacciAutoDraw signal engine initialized");
}
...
{
    g_signalDashboard.Update("Fib Retracement Touch", g_signalJournal.GetCount(), 0, 0, 0.0,
...
void ML_OnDeinit()
{
    ...
    Print("[ML] FibonacciAutoDraw signal engine shutdown");
}
...
void OnDeinit(const int reason) {
    ML_OnDeinit(); ObjectsDeleteAll(0, "FIB_"); }
