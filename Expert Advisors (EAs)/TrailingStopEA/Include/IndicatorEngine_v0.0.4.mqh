//+------------------------------------------------------------------+
//| IndicatorEngine_v0.0.4.mqh — TrailingStopEA Indicator Management
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef TRAILINGSTOPEA_INDICATOR_ENGINE_MQH
#define TRAILINGSTOPEA_INDICATOR_ENGINE_MQH
...
#endif // TRAILINGSTOPEA_INDICATOR_ENGINE_MQH
