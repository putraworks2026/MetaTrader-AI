...
//+------------------------------------------------------------------+
#ifndef LIQUIDITYZONES_OPTIMIZATION_ENGINE_MQH
#define LIQUIDITYZONES_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "LiquidityZones\\changes.csv";
...
#endif // LIQUIDITYZONES_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
