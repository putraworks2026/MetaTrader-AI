...
//| TrailingStopEA — Self-Improving MT5 AI Tool (PutraWorks)                    |
//+------------------------------------------------------------------+
#ifndef TRAILINGSTOPEA_DASHBOARD_MQH
#define TRAILINGSTOPEA_DASHBOARD_MQH
...
#endif // TRAILINGSTOPEA_DASHBOARD_MQH
//+------------------------------------------------------------------+
