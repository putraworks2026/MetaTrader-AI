//+------------------------------------------------------------------+
//| SignalDashboard_v0.0.4.mqh — LiquidityZones Signal Accuracy Display
//| Copyright 2026, PutraWorks
//| Shows: Liquidity Sweep accuracy stats
//+------------------------------------------------------------------+
#ifndef LIQUIDITYZONES_SIGNAL_DASHBOARD_MQH
#define LIQUIDITYZONES_SIGNAL_DASHBOARD_MQH
...
public:
   ...
   void Update(string signalType, int totalSignals, int successes, int failures, double successRate, string topInsight, int patternCount)
   {
      ...
      Lbl(m_prefix+"title","LiquidityZones Signal ML",m_x+10,m_y+5,clrGold,10);
      Lbl(m_prefix+"signal","Signal: Liquidity Sweep",m_x+10,m_y+22,clrSkyBlue,8);
...
#endif // LIQUIDITYZONES_SIGNAL_DASHBOARD_MQH
