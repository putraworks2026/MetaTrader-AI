...
//| Part of: AutoSupportResistance v0.0.3
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef __ML_DASHBOARD_AUTOSUPPORTRESISTANCE_MQH__
#define __ML_DASHBOARD_AUTOSUPPORTRESISTANCE_MQH__
...
#endif // __ML_DASHBOARD_AUTOSUPPORTRESISTANCE_MQH__
