...
//+------------------------------------------------------------------+
#ifndef FAIRVALUEGAP_OPTIMIZATION_ENGINE_MQH
#define FAIRVALUEGAP_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "FairValueGap\\changes.csv";
...
#endif // FAIRVALUEGAP_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
