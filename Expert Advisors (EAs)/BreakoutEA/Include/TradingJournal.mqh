...
//| BreakoutEA — Self-Improving MT5 AI Tool (PutraWorks)                    |
//+------------------------------------------------------------------+
#ifndef BREAKOUTEA_TRADING_JOURNAL_MQH
#define BREAKOUTEA_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "BreakoutEA");
...
#endif // BREAKOUTEA_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
