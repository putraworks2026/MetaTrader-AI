...
//| GridTradingEA — Self-Improving MT5 AI Tool (PutraWorks)                    |
//+------------------------------------------------------------------+
#ifndef GRIDTRADINGEA_DASHBOARD_MQH
#define GRIDTRADINGEA_DASHBOARD_MQH
...
#endif // GRIDTRADINGEA_DASHBOARD_MQH
//+------------------------------------------------------------------+
