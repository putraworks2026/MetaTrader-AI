...
//+------------------------------------------------------------------+
#ifndef FAIRVALUEGAP_STRATEGY_EVOLUTION_MQH
#define FAIRVALUEGAP_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "FairValueGap\\profiles.csv";
...
#endif // FAIRVALUEGAP_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
