...
//+------------------------------------------------------------------+
#ifndef SESSIONSKILLZONES_STRATEGY_EVOLUTION_MQH
#define SESSIONSKILLZONES_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "SessionsKillzones\\profiles.csv";
...
#endif // SESSIONSKILLZONES_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
