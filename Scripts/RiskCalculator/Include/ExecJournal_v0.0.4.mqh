//+------------------------------------------------------------------+
//| ExecJournal_v0.0.4.mqh — RiskCalculator Execution Journal
//| Copyright 2026, PutraWorks
//| Logs each: Calculate Lot Size
//+------------------------------------------------------------------+
#ifndef RISKCALCULATOR_EXEC_JOURNAL_MQH
#define RISKCALCULATOR_EXEC_JOURNAL_MQH
...
#endif // RISKCALCULATOR_EXEC_JOURNAL_MQH
