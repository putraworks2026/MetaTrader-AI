//+------------------------------------------------------------------+
//| OrderBlocks_TestSuite_v0.0.4.mq5 — Unit Tests
//| OrderBlocks — Signal ML Test Suite (PutraWorks)
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for OrderBlocks signal ML modules"
...
{
    Print("====================================");
    Print("  OrderBlocks Signal ML Test Suite");
    Print("  Signal Type: OB Mitigation");
    Print("====================================");
