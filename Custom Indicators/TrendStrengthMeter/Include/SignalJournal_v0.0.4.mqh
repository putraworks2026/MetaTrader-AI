//+------------------------------------------------------------------+
//| SignalJournal_v0.0.4.mqh — TrendStrengthMeter Signal Accuracy Journal
//| Copyright 2026, PutraWorks
//| Tracks: ADX Trend Strength
//+------------------------------------------------------------------+
#ifndef TRENDSTRENGTHMETER_SIGNAL_JOURNAL_MQH
#define TRENDSTRENGTHMETER_SIGNAL_JOURNAL_MQH

#include "SignalConfig_v0.0.4.mqh"

//--- TrendStrengthMeter Signal Entry
struct SignalEntry
{
...
#endif // TRENDSTRENGTHMETER_SIGNAL_JOURNAL_MQH
