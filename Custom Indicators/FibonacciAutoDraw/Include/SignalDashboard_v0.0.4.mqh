//+------------------------------------------------------------------+
//| SignalDashboard_v0.0.4.mqh — FibonacciAutoDraw Signal Accuracy Display
//| Copyright 2026, PutraWorks
//| Shows: Fib Retracement Touch accuracy stats
//+------------------------------------------------------------------+
#ifndef FIBONACCIAUTODRAW_SIGNAL_DASHBOARD_MQH
#define FIBONACCIAUTODRAW_SIGNAL_DASHBOARD_MQH
...
public:
   ...
   void Update(string signalType, int totalSignals, int successes, int failures, double successRate, string topInsight, int patternCount)
   {
      ...
      Lbl(m_prefix+"title","FibonacciAutoDraw Signal ML",m_x+10,m_y+5,clrGold,10);
      Lbl(m_prefix+"signal","Signal: Fib Retracement Touch",m_x+10,m_y+22,clrSkyBlue,8);
...
#endif // FIBONACCIAUTODRAW_SIGNAL_DASHBOARD_MQH
