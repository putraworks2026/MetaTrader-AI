//+------------------------------------------------------------------+
//| LearningEngine_v0.0.4.mqh — GridTradingEA Post-Trade Learning
//| Copyright 2026, PutraWorks
//| Patterns: RangeBound, TrendingUp, TrendingDown, GridRecovery
//+------------------------------------------------------------------+
#ifndef GRIDTRADINGEA_LEARNING_ENGINE_MQH
#define GRIDTRADINGEA_LEARNING_ENGINE_MQH
...
public:
   ...
   {
      if(je.outcome==OUTCOME_WIN) { ML_Lesson l; l.category="RangeBound"; l.description="Wider spacing reduces liquidation risk"; l.impact=1.0; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      else if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="RangeBound"; l.description="CONTRADICTS: Wider spacing reduces liquidation risk"; l.impact=-0.5; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      if(je.outcome==OUTCOME_WIN) { ML_Lesson l; l.category="TrendingUp"; l.description="Grid works best ADX<25"; l.impact=1.0; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      else if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="TrendingUp"; l.description="CONTRADICTS: Grid works best ADX<25"; l.impact=-0.5; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="TrendingDown"; l.description="Buy-only grids outperform uptrends"; l.impact=-0.8; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
      if(je.outcome==OUTCOME_LOSS) { ML_Lesson l; l.category="GridRecovery"; l.description="Max 5 levels prevents overexposure"; l.impact=-0.8; l.created=TimeCurrent(); l.occurrences=1; AddLesson(l); }
...
#endif // GRIDTRADINGEA_LEARNING_ENGINE_MQH
