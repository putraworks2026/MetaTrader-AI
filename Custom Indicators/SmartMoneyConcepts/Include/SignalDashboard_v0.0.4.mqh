//+------------------------------------------------------------------+
//| SignalDashboard_v0.0.4.mqh — SmartMoneyConcepts Signal Accuracy Display
//| Copyright 2026, PutraWorks
//| Shows: BOS/CHoCH accuracy stats
//+------------------------------------------------------------------+
#ifndef SMARTMONEYCONCEPTS_SIGNAL_DASHBOARD_MQH
#define SMARTMONEYCONCEPTS_SIGNAL_DASHBOARD_MQH
...
public:
   ...
   void Update(string signalType, int totalSignals, int successes, int failures, double successRate, string topInsight, int patternCount)
   {
      ...
      Lbl(m_prefix+"title","SmartMoneyConcepts Signal ML",m_x+10,m_y+5,clrGold,10);
      Lbl(m_prefix+"signal","Signal: BOS/CHoCH",m_x+10,m_y+22,clrSkyBlue,8);
...
#endif // SMARTMONEYCONCEPTS_SIGNAL_DASHBOARD_MQH
