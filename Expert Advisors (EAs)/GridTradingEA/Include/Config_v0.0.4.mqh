//+------------------------------------------------------------------+
//| Config_v0.0.4.mqh — GridTradingEA Configuration
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef GRIDTRADINGEA_CONFIG_MQH
#define GRIDTRADINGEA_CONFIG_MQH
...
struct ParameterSet
{
   int id; string name;
   double   gridSpacing;
   double   maxGridLevels;
   double   gridDirection;
   double   gridLotMultiplier;
...
{
   ps.id=id; ps.name="Default"; ps.gridSpacing = 50;
   ps.maxGridLevels = 5;
   ps.gridDirection = 0;
   ps.gridLotMultiplier = 1.0;
...
#endif // GRIDTRADINGEA_CONFIG_MQH
