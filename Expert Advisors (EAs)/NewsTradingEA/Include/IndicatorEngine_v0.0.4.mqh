//+------------------------------------------------------------------+
//| IndicatorEngine_v0.0.4.mqh — NewsTradingEA Indicator Management
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef NEWSTRADINGEA_INDICATOR_ENGINE_MQH
#define NEWSTRADINGEA_INDICATOR_ENGINE_MQH
...
#endif // NEWSTRADINGEA_INDICATOR_ENGINE_MQH
