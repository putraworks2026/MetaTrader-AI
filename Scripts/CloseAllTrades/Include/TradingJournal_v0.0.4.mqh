...
//+------------------------------------------------------------------+
#ifndef CLOSEALLTRADES_TRADING_JOURNAL_MQH
#define CLOSEALLTRADES_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "CloseAllTrades");
...
#endif // CLOSEALLTRADES_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
