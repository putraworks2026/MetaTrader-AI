//+------------------------------------------------------------------+
//| SupplyDemandZones_TestSuite_v0.0.4.mq5 — Unit Tests
//| SupplyDemandZones — Signal ML Test Suite (PutraWorks)
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for SupplyDemandZones signal ML modules"
...
{
    Print("====================================");
    Print("  SupplyDemandZones Signal ML Test Suite");
    Print("  Signal Type: Zone Touch");
    Print("====================================");
