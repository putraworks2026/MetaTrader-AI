...
//+------------------------------------------------------------------+
#ifndef AUTOSUPPORTRESISTANCE_OPTIMIZATION_ENGINE_MQH
#define AUTOSUPPORTRESISTANCE_OPTIMIZATION_ENGINE_MQH
...
{
   string fileName = "AutoSupportResistance\\changes.csv";
...
#endif // AUTOSUPPORTRESISTANCE_OPTIMIZATION_ENGINE_MQH
//+------------------------------------------------------------------+
