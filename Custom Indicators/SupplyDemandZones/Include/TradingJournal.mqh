...
//+------------------------------------------------------------------+
#ifndef SUPPLYDEMANDZONES_TRADING_JOURNAL_MQH
#define SUPPLYDEMANDZONES_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "SupplyDemandZones");
...
CTradingJournal::CTradingJournal()
{
   ...
   m_folderName = "SupplyDemandZones";
   m_nextId = 1;
}
...
#endif // SUPPLYDEMANDZONES_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
