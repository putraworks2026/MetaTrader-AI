//+------------------------------------------------------------------+
//| NewsManager_v0.0.4.mqh — GridTradingEA Economic News Filter
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef GRIDTRADINGEA_NEWS_MANAGER_MQH
#define GRIDTRADINGEA_NEWS_MANAGER_MQH
...
#endif // GRIDTRADINGEA_NEWS_MANAGER_MQH
