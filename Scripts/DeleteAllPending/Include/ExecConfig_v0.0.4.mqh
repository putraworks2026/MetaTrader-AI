//+------------------------------------------------------------------+
//| ExecConfig_v0.0.4.mqh — DeleteAllPending Execution Configuration
//| Copyright 2026, PutraWorks
//| Action: Delete Pending Orders
//+------------------------------------------------------------------+
#ifndef DELETEALLPENDING_EXEC_CONFIG_MQH
#define DELETEALLPENDING_EXEC_CONFIG_MQH
...
#endif // DELETEALLPENDING_EXEC_CONFIG_MQH
