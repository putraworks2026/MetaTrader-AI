//+------------------------------------------------------------------+
//| SignalDashboard_v0.0.4.mqh — SupplyDemandZones Signal Accuracy Display
//| Copyright 2026, PutraWorks
//| Shows: Zone Touch accuracy stats
//+------------------------------------------------------------------+
#ifndef SUPPLYDEMANDZONES_SIGNAL_DASHBOARD_MQH
#define SUPPLYDEMANDZONES_SIGNAL_DASHBOARD_MQH
...
public:
   ...
   void Update(string signalType, int totalSignals, int successes, int failures, double successRate, string topInsight, int patternCount)
   {
      ...
      Lbl(m_prefix+"title","SupplyDemandZones Signal ML",m_x+10,m_y+5,clrGold,10);
      Lbl(m_prefix+"signal","Signal: Zone Touch",m_x+10,m_y+22,clrSkyBlue,8);
...
#endif // SUPPLYDEMANDZONES_SIGNAL_DASHBOARD_MQH
