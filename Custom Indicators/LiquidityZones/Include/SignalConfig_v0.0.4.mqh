//+------------------------------------------------------------------+
//| SignalConfig_v0.0.4.mqh — LiquidityZones Signal Configuration
//| Copyright 2026, PutraWorks
//| Signal Type: Liquidity Sweep
//+------------------------------------------------------------------+
#ifndef LIQUIDITYZONES_SIGNAL_CONFIG_MQH
#define LIQUIDITYZONES_SIGNAL_CONFIG_MQH
...
#endif // LIQUIDITYZONES_SIGNAL_CONFIG_MQH
