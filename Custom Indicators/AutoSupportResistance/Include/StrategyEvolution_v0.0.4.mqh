...
//+------------------------------------------------------------------+
#ifndef AUTOSUPPORTRESISTANCE_STRATEGY_EVOLUTION_MQH
#define AUTOSUPPORTRESISTANCE_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "AutoSupportResistance\\profiles.csv";
...
#endif // AUTOSUPPORTRESISTANCE_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
