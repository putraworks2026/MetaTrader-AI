//+------------------------------------------------------------------+
//| RiskManager_v0.0.4.mqh — ScalpingEA Risk Management
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef SCALPINGEA_RISK_MANAGER_MQH
#define SCALPINGEA_RISK_MANAGER_MQH
...
#endif // SCALPINGEA_RISK_MANAGER_MQH
