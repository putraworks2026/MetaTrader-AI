...
//| Part of: ExportTradeHistory v0.0.3
//| Copyright 2026, PutraWorks
//+------------------------------------------------------------------+
#ifndef __ML_JOURNAL_EXPORTTRADEHISTORY_MQH__
#define __ML_JOURNAL_EXPORTTRADEHISTORY_MQH__
...
#endif // __ML_JOURNAL_EXPORTTRADEHISTORY_MQH__
