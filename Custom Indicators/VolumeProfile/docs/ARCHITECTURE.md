...
Volume at price levels with POC and value area. Part of the PutraWorks MetaTrader-AI collection.

## Signal Type

This indicator generates **POC Touch** signals.

## ML Module Architecture

```
┌─────────────────────────────────────────────────────────┐
│                  VolumeProfile_v0.0.4.mq5                       │
...
| SignalJournal | SignalJournal_v0.0.4.mqh | Tracks POC Touch signal accuracy (price after 1/5/10 bars) |
| SignalLearning | SignalLearning_v0.0.4.mqh | Learns which POC Touch conditions are reliable |
| SignalPatterns | SignalPatterns_v0.0.4.mqh | Scores POC Touch conditions by success rate |
...
```
VolumeProfile/
├── VolumeProfile_v0.0.4.mq5              # Main file — compile this
├── Include/
│   ├── VolumeProfile_v0.0.4.mqh           # Core indicator logic
...
├── Tests/VolumeProfile_TestSuite_v0.0.4.mq5
├── docs/
│   ├── ARCHITECTURE.md
│   ├── USER_GUIDE.md
│   └── CHANGELOG.md
...
└── Archive/                       # Previous versions (read-only)
    ├── VolumeProfile_v0.0.1.mq5
    ├── VolumeProfile_v0.0.2.mq5
    └── VolumeProfile_v0.0.3.mq5
```
