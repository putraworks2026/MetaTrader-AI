...
//+------------------------------------------------------------------+
#ifndef SCALPINGEA_TRADING_JOURNAL_MQH
#define SCALPINGEA_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "ScalpingEA");
...
#endif // SCALPINGEA_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
