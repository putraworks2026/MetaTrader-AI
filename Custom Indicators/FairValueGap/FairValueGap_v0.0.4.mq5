//+------------------------------------------------------------------+
//| FairValueGap_v0.0.4.mq5 — Publish Entry Point
...
#include "Include/FairValueGap_v0.0.4.mqh"
...
void ML_Init()
{
    g_signalJournal.Init("FairValueGap");
    g_signalLearning.Init("FairValueGap");
    g_signalDashboard.Init("FairValueGap");
    Print("[ML] FairValueGap signal engine initialized");
}
...
{
    g_signalDashboard.Update("FVG Fill/Bounce", g_signalJournal.GetCount(), 0, 0, 0.0,
...
void ML_OnDeinit()
{
    ...
    Print("[ML] FairValueGap signal engine shutdown");
}
...
void OnDeinit(const int reason) {
    ML_OnDeinit(); ObjectsDeleteAll(0, "FVG_"); }
