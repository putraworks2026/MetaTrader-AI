# ScalpingEA — Changelog

## v0.0.4 — 2026-08-09

### Changed
- Replaced generic AIEA copies with tool-specific ML modules
- Config now has ScalpingEA-specific parameters: scalpTP, scalpSL, maxSpread, rsiPeriod
- LearningEngine now has ScalpingEA-specific lessons for OversoldBounce, OverboughtDrop, SpreadSqueeze, MicroTrend
- PatternRecognition now tracks ScalpingEA-specific patterns: OversoldBounce, OverboughtDrop, SpreadSqueeze, MicroTrend
