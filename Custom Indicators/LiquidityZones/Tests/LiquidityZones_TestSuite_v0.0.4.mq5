//+------------------------------------------------------------------+
//| LiquidityZones_TestSuite_v0.0.4.mq5 — Unit Tests
//| LiquidityZones — Signal ML Test Suite (PutraWorks)
//+------------------------------------------------------------------+
#property strict
#property description "Unit tests for LiquidityZones signal ML modules"
...
{
    Print("====================================");
    Print("  LiquidityZones Signal ML Test Suite");
    Print("  Signal Type: Liquidity Sweep");
    Print("====================================");
