//+------------------------------------------------------------------+
//| OptimizationEngine_v0.0.4.mqh — NewsTradingEA Adaptive Optimization
//| Copyright 2026, PutraWorks
//| Optimizable: newsWindowMin, straddleDistance, minImpact, volatilityTP
//+------------------------------------------------------------------+
#ifndef NEWSTRADINGEA_OPTIMIZATION_ENGINE_MQH
#define NEWSTRADINGEA_OPTIMIZATION_ENGINE_MQH
...
#endif // NEWSTRADINGEA_OPTIMIZATION_ENGINE_MQH
