//+------------------------------------------------------------------+
//| ExecJournal_v0.0.4.mqh — ExportTradeHistory Execution Journal
//| Copyright 2026, PutraWorks
//| Logs each: Export to CSV
//+------------------------------------------------------------------+
#ifndef EXPORTTRADEHISTORY_EXEC_JOURNAL_MQH
#define EXPORTTRADEHISTORY_EXEC_JOURNAL_MQH
...
#endif // EXPORTTRADEHISTORY_EXEC_JOURNAL_MQH
