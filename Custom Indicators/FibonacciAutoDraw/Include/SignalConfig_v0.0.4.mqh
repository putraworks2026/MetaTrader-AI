//+------------------------------------------------------------------+
//| SignalConfig_v0.0.4.mqh — FibonacciAutoDraw Signal Configuration
//| Copyright 2026, PutraWorks
//| Signal Type: Fib Retracement Touch
//+------------------------------------------------------------------+
#ifndef FIBONACCIAUTODRAW_SIGNAL_CONFIG_MQH
#define FIBONACCIAUTODRAW_SIGNAL_CONFIG_MQH
...
//--- FibonacciAutoDraw Signal Profile
...
#endif // FIBONACCIAUTODRAW_SIGNAL_CONFIG_MQH
