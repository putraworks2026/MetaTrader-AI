# AutoSupportResistance — User Guide

## Description

Auto-draws support/resistance from swing points.

## Installation

1. Copy the entire `AutoSupportResistance/` folder to your MT5 `MQL5/Indicators/` directory
2. Open MetaEditor (F4 in MT5 terminal)
3. Navigate to the `AutoSupportResistance/` folder
4. Compile `AutoSupportResistance_v0.0.4.mq5` (F7)
...
- Which market regimes favor S/R Level Touch signals
...
ML data is stored in `MQL5/Files/AutoSupportResistance/`:
...
Run the test suite:
1. Compile `Tests/AutoSupportResistance_TestSuite_v0.0.4.mq5` in MetaEditor
