...
//+------------------------------------------------------------------+
#ifndef SETBREAKEVENALL_STRATEGY_EVOLUTION_MQH
#define SETBREAKEVENALL_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "SetBreakevenAll\\profiles.csv";
...
#endif // SETBREAKEVENALL_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
