//+------------------------------------------------------------------+
//| ExecConfig_v0.0.4.mqh — SetBreakevenAll Execution Configuration
//| Copyright 2026, PutraWorks
//| Action: Set Breakeven
//+------------------------------------------------------------------+
#ifndef SETBREAKEVENALL_EXEC_CONFIG_MQH
#define SETBREAKEVENALL_EXEC_CONFIG_MQH
...
#endif // SETBREAKEVENALL_EXEC_CONFIG_MQH
