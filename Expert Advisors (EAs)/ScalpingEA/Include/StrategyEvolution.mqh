...
//+------------------------------------------------------------------+
#ifndef SCALPINGEA_STRATEGY_EVOLUTION_MQH
#define SCALPINGEA_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "ScalpingEA\\profiles.csv";
...
#endif // SCALPINGEA_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
