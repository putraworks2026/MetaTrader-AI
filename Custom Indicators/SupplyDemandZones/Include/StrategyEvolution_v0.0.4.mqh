...
//+------------------------------------------------------------------+
#ifndef SUPPLYDEMANDZONES_STRATEGY_EVOLUTION_MQH
#define SUPPLYDEMANDZONES_STRATEGY_EVOLUTION_MQH
...
{
   string fileName = "SupplyDemandZones\\profiles.csv";
...
#endif // SUPPLYDEMANDZONES_STRATEGY_EVOLUTION_MQH
//+------------------------------------------------------------------+
