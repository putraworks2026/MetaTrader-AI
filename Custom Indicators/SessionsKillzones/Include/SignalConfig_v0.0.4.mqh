//+------------------------------------------------------------------+
//| SignalConfig_v0.0.4.mqh — SessionsKillzones Signal Configuration
//| Copyright 2026, PutraWorks
//| Signal Type: Session Break
//+------------------------------------------------------------------+
#ifndef SESSIONSKILLZONES_SIGNAL_CONFIG_MQH
#define SESSIONSKILLZONES_SIGNAL_CONFIG_MQH
...
//--- SessionsKillzones Signal Profile
...
#endif // SESSIONSKILLZONES_SIGNAL_CONFIG_MQH
