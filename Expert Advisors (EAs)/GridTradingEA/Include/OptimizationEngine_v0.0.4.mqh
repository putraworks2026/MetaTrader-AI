//+------------------------------------------------------------------+
//| OptimizationEngine_v0.0.4.mqh — GridTradingEA Adaptive Optimization
//| Copyright 2026, PutraWorks
//| Optimizable: gridSpacing, maxGridLevels, gridDirection, gridLotMultiplier
//+------------------------------------------------------------------+
#ifndef GRIDTRADINGEA_OPTIMIZATION_ENGINE_MQH
#define GRIDTRADINGEA_OPTIMIZATION_ENGINE_MQH
...
#endif // GRIDTRADINGEA_OPTIMIZATION_ENGINE_MQH
