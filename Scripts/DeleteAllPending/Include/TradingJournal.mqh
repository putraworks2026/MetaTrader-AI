...
//+------------------------------------------------------------------+
#ifndef DELETEALLPENDING_TRADING_JOURNAL_MQH
#define DELETEALLPENDING_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "DeleteAllPending");
...
#endif // DELETEALLPENDING_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
