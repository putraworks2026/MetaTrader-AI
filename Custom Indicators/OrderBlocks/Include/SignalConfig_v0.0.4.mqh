//+------------------------------------------------------------------+
//| SignalConfig_v0.0.4.mqh — OrderBlocks Signal Configuration
//| Copyright 2026, PutraWorks
//| Signal Type: OB Mitigation
//+------------------------------------------------------------------+
#ifndef ORDERBLOCKS_SIGNAL_CONFIG_MQH
#define ORDERBLOCKS_SIGNAL_CONFIG_MQH
...
#endif // ORDERBLOCKS_SIGNAL_CONFIG_MQH
