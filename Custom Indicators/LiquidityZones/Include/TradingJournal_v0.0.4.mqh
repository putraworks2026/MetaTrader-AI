...
//+------------------------------------------------------------------+
#ifndef LIQUIDITYZONES_TRADING_JOURNAL_MQH
#define LIQUIDITYZONES_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "LiquidityZones");
...
#endif // LIQUIDITYZONES_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
