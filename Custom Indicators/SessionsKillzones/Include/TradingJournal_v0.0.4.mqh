...
//+------------------------------------------------------------------+
#ifndef SESSIONSKILLZONES_TRADING_JOURNAL_MQH
#define SESSIONSKILLZONES_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "SessionsKillzones");
...
CTradingJournal::CTradingJournal()
{
   ...
   m_folderName = "SessionsKillzones";
   m_nextId = 1;
}
...
#endif // SESSIONSKILLZONES_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
