//+------------------------------------------------------------------+
//| SignalDashboard_v0.0.4.mqh — VolumeProfile Signal Accuracy Display
//| Copyright 2026, PutraWorks
//| Shows: POC Touch accuracy stats
//+------------------------------------------------------------------+
#ifndef VOLUMEPROFILE_SIGNAL_DASHBOARD_MQH
#define VOLUMEPROFILE_SIGNAL_DASHBOARD_MQH
...
public:
   ...
   void Update(string signalType, int totalSignals, int successes, int failures, double successRate, string topInsight, int patternCount)
   {
      ...
      Lbl(m_prefix+"title","VolumeProfile Signal ML",m_x+10,m_y+5,clrGold,10);
      Lbl(m_prefix+"signal","Signal: POC Touch",m_x+10,m_y+22,clrSkyBlue,8);
...
#endif // VOLUMEPROFILE_SIGNAL_DASHBOARD_MQH
