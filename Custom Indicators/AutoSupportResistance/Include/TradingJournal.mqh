...
//| AutoSupportResistance — Self-Improving MT5 AI Tool (PutraWorks)                    |
//+------------------------------------------------------------------+
#ifndef AUTOSUPPORTRESISTANCE_TRADING_JOURNAL_MQH
#define AUTOSUPPORTRESISTANCE_TRADING_JOURNAL_MQH
...
public:
   ...
   bool   Init(string folder = "AutoSupportResistance");
...
CTradingJournal::CTradingJournal()
{
   ...
   m_folderName = "AutoSupportResistance";
   m_nextId = 1;
}
...
#endif // AUTOSUPPORTRESISTANCE_TRADING_JOURNAL_MQH
//+------------------------------------------------------------------+
