...
//+------------------------------------------------------------------+
#ifndef AUTOSUPPORTRESISTANCE_REPORT_GENERATOR_MQH
#define AUTOSUPPORTRESISTANCE_REPORT_GENERATOR_MQH
...
#include "OptimizationEngine_v0.0.4.mqh"
...
CReportGenerator::CReportGenerator()
{
   ...
   m_folder = "AutoSupportResistance";
}
...
#endif // AUTOSUPPORTRESISTANCE_REPORT_GENERATOR_MQH
//+------------------------------------------------------------------+
