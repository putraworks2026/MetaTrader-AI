...
//| TrendStrengthMeter — Self-Improving MT5 AI Tool (PutraWorks)                    |
//+------------------------------------------------------------------+
#ifndef TRENDSTRENGTHMETER_DASHBOARD_MQH
#define TRENDSTRENGTHMETER_DASHBOARD_MQH
...
#endif // TRENDSTRENGTHMETER_DASHBOARD_MQH
//+------------------------------------------------------------------+
